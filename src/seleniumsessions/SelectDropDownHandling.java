...
public class SelectDropDownHandling {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		By country = By.id("Form_getForm_Country");	// First Step locator	
		WebElement country_ele = driver.findElement(country);// second step web element
		Select select = new Select(country_ele);//third step pass web element to Select class
